                ...
                <div class="right">
                    ...
                    >
                        <el-row class="content-row-col">
                            <el-col :span="7" class="andon-list"
                                ><span class="span-style"
                                    >{{ item.pointCode }}工位</span
                                ></el-col
                            >
                            <el-col :span="5" class="andon-list"
                                ><span class="span-style" style="color: red"
                                    >{{ item.andonType }}
                                </span></el-col
                            >
                            <el-col :span="8" class="andon-list"
                                ><span class="span-style">{{
                                    item.andonSdt
                                }}</span></el-col
                            >
                            <el-col :span="4" class="andon-list"
                                ><span class="span-style">{{
                                    item.timeDiff
                                }}</span></el-col
                            >
