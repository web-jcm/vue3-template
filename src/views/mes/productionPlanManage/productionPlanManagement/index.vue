<template>
    <div class="app-container app-container-table">
        <div class="nav_wrap">
            <div
                class="nav_btn"
                @click="navigate('productionSequenceAdjustment')"
            >
                生产顺序调整
            </div>
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="saveEditYear"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
...
export default {
                ...
                this.$ConfigCache.CacheConfig.cacheData[viewPageCode]
                    ...
                    : [
                          ...
                          },
                        {
                            ...
                            type: "",
                            size: "small",
                            clickEvent: () => this.handleOpenDialog(),
                            text: this.$t("导入"),
                            name: "importTemplate",
                            position: "right",
                          },
                        ...
                        {
                            compKey: "btnKey_importTemplateDownload",
                              type: "",
                            size: "small",
    ...
    methods: {
        onExport() {
            exportCommon(
                "/ly/mp/mom/mes/vmes/base/CarBaseService/queryCarInfoJdbcExport.do",
                this.formField,
                "生产计划导出"
            );
        },
