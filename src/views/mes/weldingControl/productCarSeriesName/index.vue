<template>
    <div class="app-container app-container-table">
        ...
        <div class="contain">
            ...
            >
                <div class="label">({{ item.LOOKUP_VALUE_CODE }})</div>
                <el-input
                    v-rule="'18'"
                    v-model="item.LOOKUP_VALUE_NAME"
                ></el-input>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        search() {
            this.formList = [];
            this.queryLookupValues("SYAKEI_TYPE");
        },
        save() {
...
@import "@/styles/mes/productCarSeriesName/productCarSeriesName.scss";
</style>
