...
import {
    querySubline,
    queryLineNo,
    queryProductPointerSubLine,
} from "@/api/apiList/mes";

import Vue from "vue";

export default {
    name: "productIndicatePointerShow",
    components: {
            ...
            infoComponents: [
                {
                    ...
                    codeField: "tableType",
                    component: () =>
                        import("@/components/org/radioBox/radioBtn"),
                    isComponent: true,
                    size: "small",
                    options: [
                        {
    ...
    watch: {
        ...
        "resultField.tableType": function (val) {
            this.refreshTableKey = Math.random() + "";
            this.$refs.multipleTable.list = [];
            if (val === "0") {
                this.tableCols[4].hidden = true;
                this.infoComponents[2].disabled = false;
                this.querySubline();
            } else {
                this.tableCols[4].hidden = false;
                this.infoComponents[2].disabled = true;
                this.queryProductPointerSubLine();
            }
        },
        "resultField.sortType": function (val) {
            this.search();
        },
    ...
    methods: {
        ...
        search() {
            ...
            //   } else {
            this.$refs.multipleTable.list = [];
            if (this.resultField.tableType === "0") {
                this.querySubline();
            } else {
                this.queryProductPointerSubLine();
            }
        ...
        querySubline() {
            ...
            querySubline({
                ...
                PROCESS_LOCATION: "M",
                ORDER_BY: this.resultField.sortType,
                NAME_NOT_NULL: "1",
            })
                .then((res) => {
                    this.loading.close();
        ...
        queryProductPointerSubLine() {
            ...
            queryProductPointerSubLine({
                ...
                LINE_NO: this.formField.LINE_NO,
                PROCESS_LOCATION: "M",
                QUEUE_TYPE: this.resultField.tableType,
                QUEUE_DIV: 2,
                NAME_NOT_NULL: "1",
            })
                .then((res) => {
...
@import "@/styles/mes/productIndicatePointerShow/productIndicatePointerShow.scss";
</style>
